...
#| fig-cap: "Mean monthly rainfall change (mm) relative to a 1990 baseline for (A) tree cover and (B) freshwater wetland ecosystem types across moku in the Main Hawaiian Islands. Each bar is the mean of 2013 and 2019 baseline differences."
...
#| fig-cap: "Maximum and mean monthly rainfall (mm) for tree cover and freshwater wetland ecosystem types across moku in the Main Hawaiian Islands (excluding Niʻihau, no data), comparing 1990 reference conditions to 2013 and 2019 accounting periods. Within each panel, moku are ordered by that metric's 1990 value."
